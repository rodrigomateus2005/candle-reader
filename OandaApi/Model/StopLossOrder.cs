...
namespace IO.Swagger.Model {
  ...
  public class StopLossOrder {
    ...
    /// </summary>
    /// <value>The type of the Order. Always set to \"STOP_LOSS\" for Stop Loss Orders.</value>
    ...
    [JsonProperty(PropertyName = "guaranteedExecutionPremium")]
    public string GuaranteedExecutionPremium { get; set; }
